...
Quick step-by-step guide to use TSSpredator with the second example data provided at `the website
<https://uni-tuebingen.de/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/informatik/lehrstuehle/integrative-transkriptomik/software/tsspredator/>
`_. The example data provided here is the S. aureus data comparing wildtype and a knockout mutant.
